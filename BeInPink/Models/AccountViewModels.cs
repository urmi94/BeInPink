...
namespace BeInPink.Models
{
    public class ExternalLoginConfirmationViewModel
    {
        ...
        [Required(ErrorMessage = "It is important for us to know who you are.")]
    ...
    public class EditCoachProfileViewModel
    {
        ...
        [Required(ErrorMessage = "It is important for your clients to now what coaching you provide.")]
